'use strict';exports.__esModule = true;var _regenerator = require('babel-runtime/regenerator');var _regenerator2 = _interopRequireDefault(_regenerator);var _asyncToGenerator2 = require('babel-runtime/helpers/asyncToGenerator');var _asyncToGenerator3 = _interopRequireDefault(_asyncToGenerator2);var _classCallCheck2 = require('babel-runtime/helpers/classCallCheck');var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _possibleConstructorReturn2 = require('babel-runtime/helpers/possibleConstructorReturn');var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);var _inherits2 = require('babel-runtime/helpers/inherits');var _inherits3 = _interopRequireDefault(_inherits2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _class = function (_think$controller$bas) {(0, _inherits3.default)(_class, _think$controller$bas);function _class() {(0, _classCallCheck3.default)(this, _class);return (0, _possibleConstructorReturn3.default)(this, _think$controller$bas.apply(this, arguments));}
        ...
        __before = function () {var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {var _web, csrf, uinfo, islogin, logininfo, memberList, tagList, navList, linksList;return _regenerator2.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                                                        ...
                                                        think.isEmpty(uinfo)) {_context.next = 18;break;}_context.next = 16;return (
                                                                this.model('topic').findAll('user', { name: uinfo.name }));case 16:logininfo = _context.sent;
                                                        this.assign("logininfo", logininfo[0]);case 18:_context.next = 20;return (




                                                                this.model("topic").getMemberList({ role: 4 }, 9));case 20:memberList = _context.sent;
                                                        this.assign("memberList", memberList);

                                                        //获取tags
                                                        _context.next = 24;return this.model("topic").getOrderList("tags", { appear: 1 });case 24:tagList = _context.sent;
                                                        this.assign('tagList', tagList);

                                                        //获取导航链接
                                                        _context.next = 28;return this.model("topic").getOrderList('menu', { appear: 1 });case 28:navList = _context.sent;
                                                        this.assign("navList", navList);

                                                        //获取友情链接
                                                        _context.next = 32;return this.model("topic").getOrderList("links", { flag: 1 });case 32:linksList = _context.sent;
                                                        ...
                                                        this.assign("theme_url", 'static/theme/' + _web.theme + '/res');case 36:case 'end':return _context.stop();}}}, _callee, this);}));function __before() {return _ref.apply(this, arguments);}return __before;}();_class.prototype.
        ...
        getConfig = function () {var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2() {var sysdata;return _regenerator2.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                                                                this.model('topic').findOne('system', { id: 1 }));case 2:sysdata = _context2.sent;return _context2.abrupt('return',
                                                        sysdata);case 4:case 'end':return _context2.stop();}}}, _callee2, this);}));function getConfig() {return _ref2.apply(this, arguments);}return getConfig;}();
